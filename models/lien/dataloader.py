...
# author: chengzhang, https://github.com/chengzhag/Implicit3DUnderstanding
...
def LIEN_dataloader(config, mode='train'):
    dataloader = DataLoader(dataset=LIEN_Dataset(config, mode),
...
class LIEN_Dataset(PIX3DLDIF):
    def __init__(self, config, mode):
        super(LIEN_Dataset, self).__init__(config, mode)
