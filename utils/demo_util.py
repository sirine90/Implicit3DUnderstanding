...
def get_shape_comp_model(opt):
    ...
    opt.ckpt = 'out/autosdf/rand_tf_epoch-latest.pth'
    
    # load vq stuff
    opt.vq_model='pvqvae'
    opt.vq_cfg='configs/pvqvae_snet.yaml'
    opt.vq_ckpt= 'out/autosdf/vqvae_epoch-best.pth'
    #'saved_ckpt_rename_2/pvqvae-snet-all-LR1e-4-T0.2-rerun-epoch140.pth'
    opt.vq_note='default'
