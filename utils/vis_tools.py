...
from utils.front3d_utils import get_cam_KRT, get_layout_info, correct_flipped_objects
...
nyuclass_mapping = np.load(os.path.join(dataroot, 'nyu40class_mapping.npy'))
...
class Scene3D(object):
    ...
    def set_camera(self, position, focal_point, cam_K):
        ...
        #2*np.arctan(cam_K[1][2]/cam_K[0][0]))/np.pi*180
