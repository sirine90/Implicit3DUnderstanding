...
"""
# Source: https://github.com/yinyunie/Total3DUnderstanding

from utils.vis_tools import Scene3D
import numpy as np
from utils.front3d_utils import get_NYU37_class_id, cvt2nyu37class_map, process_layout, get_world_R, transform_to_world,\
...
import vtk
from utils.front3d_utils import get_layout_info, proj_from_point_to_2d, get_corners_of_bb3d_no_index
...
class Scene3D_FRONT3D(Scene3D):
    '''
    A class used to visualize scene contents.
    '''
